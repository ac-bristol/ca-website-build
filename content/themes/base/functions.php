...
function base_scripts() {
	...
	wp_enqueue_script( 'base-navigation', get_template_directory_uri() . '/js/main.js', array(), '20120206', true );
  
  //wp_enqueue_script( 'base-underscore', get_template_directory_uri() . '/js/libs/underscore-min.js', array(), '20140206', true );
  wp_enqueue_script( 'base-build', get_template_directory_uri() . '/js/build.js', array(), '20140206', true );
	wp_enqueue_script( 'base-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
  
  wp_enqueue_script( 'base-back', get_template_directory_uri() . '/js/backbone.js', array(), '20120206', true );
